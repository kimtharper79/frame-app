...
const SEED_SHOOTS: Shoot[] = [
  {
    ...
    modelsNeeded: 2,
    description: "Classic Rembrandt lighting technique for my final portfolio. Looking for models comfortable with dramatic shadows and longer sitting times.",
  ...
  },
  {
    ...
    modelsNeeded: 3,
    description: "Editorial series inspired by 1970s minimalism. Clean lines, neutral tones, flowing fabrics. Looking for diverse models comfortable with movement.",
  ...
  },
  {
    ...
    modelsNeeded: 1,
    description: "Documenting daily life in Savannah's historic district. Candid, observational style. Need someone comfortable being photographed in public spaces.",
  ...
  },
  {
    ...
    modelsNeeded: 2,
    description: "Creating abstract light paintings with human subjects. Models will need to hold still for 30-second exposures. Unique, experimental imagery.",
  ...
  },
  {
    ...
    modelsNeeded: 1,
    description: "Contemporary portraits with a focus on genuine expression. Mix of digital and film. Looking for someone expressive and comfortable in front of the camera.",
